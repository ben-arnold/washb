...
washb_bd_tr    <- data(washb_bang_tr)
washb_bd_enrol <- data(washb_bangladesh_enrol)
washb_bd_diar  <- data(washb_bangladesh_diar)
...
washb_bd_anthro <- data(washb_bangladesh_anthro)
