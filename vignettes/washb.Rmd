...
washb_bangladesh_enrol <- washb_bangladesh_anthro <- NULL
...
#dd<-loadUnblindedData("washb_bangladesh_diarCleanUnblinded")
# setwd("C:/Users/andre/Documents/washb package data/data")
#
# load("washb_bangladesh_diarCleanUnblinded.RData")
# dd<-washb_bangladesh_diarCleanUnblinded
# load("washb_bangladesh_anthroCleanUnblinded.Rdata")
# lazd<-washb_bangladesh_anthroCleanUnblinded
```
...
MomAge<-washb_mean(Y=washb_bangladesh_enrol$momage,id=washb_bangladesh_enrol$clusterid)
MomEduY<-washb_mean(Y=washb_bangladesh_enrol$momeduy,id=washb_bangladesh_enrol$clusterid)
```
...
washb_bangladesh_track_compound<-NULL
