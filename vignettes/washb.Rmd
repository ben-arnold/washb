...
washb_bd_tr    <- read.csv("data/washb-bang-tr.csv")
washb_bd_enrol <- read.csv("data/washb-bangladesh-enrol.csv")
washb_bd_diar  <- read.csv("data/washb-bangladesh-diar.csv")
...
washb_bd_anthro <- read.csv("data/washb-bangladesh-anthro.csv")
...
washb_bd_track <- read.csv("data/washb-bangladesh-track-compound.csv")
