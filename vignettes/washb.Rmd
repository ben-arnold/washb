...
washb_bd_tr    <- data(washb-bang-tr)
washb_bd_enrol <- data(washb-bangladesh-enrol)
washb_bd_diar  <- data(washb-bangladesh-diar)
...
washb_bd_anthro <- data(washb-bangladesh-anthro)
...
washb_bd_track <- data(washb-bangladesh-track-compound)
