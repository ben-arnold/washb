...
## ---- warning=FALSE, message=FALSE, eval=T, cache=TRUE------------------------------------------------------------------------------------------------------------------------------------------------
...
Ws <- subset(ad,select=c("tchild","month","agedays","sex","momage","momedu","momheight","hfiacat","Nlt18","Ncomp","watmin","elec","floor","walls","roof","asset_wardrobe","asset_table","asset_chair","asset_khat","asset_chouki","asset_tv","asset_refrig","asset_bike","asset_moto","asset_sewmach","asset_mobile"))


#Estimate subgroup analysis glm with washb_glm
glm.C.W.byChildType <- washb_glm(Y=ad$diar7d,tr=ad$tr,pair=ad$block, W=Ws, forcedW=NULL, V="tchild", id=ad$clusterid, contrast=c("Control","Water"), family=binomial(link='log'))
...
## ---- warning=FALSE, message=FALSE, eval=F, cache=TRUE------------------------------------------------------------------------------------------------------------------------------------------------
#  
#  #Create a W variable containing "tchild" and other potential covariates:
...
#  
#  #Estimate subgroup analysis glm with washb_glm
#  glm.C.W.byFoodSecurity <- washb_glm(Y=ad$diar7d,tr=ad$tr,pair=ad$block, W=Ws, forcedW=NULL, V="hfiacat", id=ad$clusterid, contrast=c("Control","Water"), family=binomial(link='log'))
