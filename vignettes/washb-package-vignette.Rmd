...
try(washb_bd_tr    <- read.csv('/Volumes/0-Treatment-assignments/washb-bangladesh-tr.csv'))
try(washb_bd_enrol <- read.csv('~/dropbox/WASHB-Bangladesh-Data/1-primary-outcome-datasets/washb-bangladesh-enrol.csv'))
try(washb_bd_diar  <- read.csv('~/dropbox/WASHB-Bangladesh-Data/1-primary-outcome-datasets/washb-bangladesh-diar.csv'))

if(is.null(washb_bd_enrol)){
  setwd("C:/Users/andre/Dropbox/WASHB Package/PrimaryOutcomeData")
washb_bd_tr    <- read.csv('washb-bang-tr.csv')
washb_bd_enrol <- read.csv('washb-bangladesh-enrol.csv')
washb_bd_diar  <- read.csv('washb-bangladesh-diar.csv')
}
...
try(washb_bd_anthro  <- read.csv('~/dropbox/WASHB-Bangladesh-Data/1-primary-outcome-datasets/washb-bangladesh-anthro.csv'))
if(is.null(washb_bd_anthro)){
    setwd("C:/Users/andre/Dropbox/WASHB Package/PrimaryOutcomeData")
  washb_bd_anthro <- read.csv('washb-bangladesh-anthro.csv')
}
...
try(washb_bd_track <- read.csv("~/dropbox/WASHB-Bangladesh-Data/1-primary-outcome-datasets/washb-bangladesh-track-compound.csv"))
if(is.null(washb_bd_track)){
  washb_bd_track <- read.csv("C:/Users/andre/Dropbox/WASHB Package/PrimaryOutcomeData/washb-bangladesh-track-compound.csv")
}
