...
The permutation test can also test for independence of Y and tr, conditional on W, by applying the `washb_permute` function to the residuals of an adjusted model. The adjusted permutation test works better on outcomes with greater variability, so will be applied to the LAZ outcome here. 
