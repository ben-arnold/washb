...
__IMPORTANT:__ _As of Oct 12, 2016 we do not recommend using the `Delta` option yet because we have not fully tested it.  This is in active testing and as soon as it's validated (very near future) we will notify collaborators and will add an example analysis for missing outcomes to this vignette._
