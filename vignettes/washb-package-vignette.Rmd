...
```{r, eval=FALSE, warning=FALSE, message=FALSE, cache=TRUE, tidy=TRUE}
...
Contrast v. control | Estimator | PR | 95% CI | SE | P-value
--------------------|-----------|----|--------|----|--------
Water | Unadjusted MH | `r round(exp(diff.h1LAZ[1,1]),2)` |(`r round(exp(diff.h1LAZ[1,3:4]),2)`) | `r round(diff.h1LAZ[1,2],4)`| `r round(diff.h1LAZ[1,5],4)`
Water | Unadjusted GLM |  `r round(unadj.glm.h1LAZ[[1]][2,1],2)` |(`r round(unadj.glm.h1LAZ[[1]][2,2:3],2)`) | `r round(unadj.glm.h1LAZ[[7]][2,2],4)` | `r round(unadj.glm.h1LAZ[[7]][2,4],4)`
Water | Adjusted GLM | `r round(adj.glm.h1LAZ[[1]][2,1],2)` |(`r round(adj.glm.h1LAZ[[1]][2,2:3],2)`) | `r round(adj.glm.h1LAZ[[7]][2,2],4)` | `r round(adj.glm.h1LAZ[[7]][2,4],4)`
Water | Adjusted GLM + TMLE |  | | | 
Water | Adjusted SL + TMLE |  | | | 
Water | Wilcoxon  permutation test |  | | | 
-----------------------------------------|--------------------------------------|---------------|--------------|------------|-------------
Sanitation | Unadjusted MH | `r round(exp(diff.h1LAZ[2,1]),2)` |(`r round(exp(diff.h1LAZ[2,3:4]),2)`) | `r round(diff.h1LAZ[2,2],4)`| `r round(diff.h1LAZ[2,5],4)`
Sanitation | Unadjusted GLM |  `r round(unadj.glm.h1LAZ[[2]][2,1],2)` |(`r round(unadj.glm.h1LAZ[[2]][2,2:3],2)`) | `r round(unadj.glm.h1LAZ[[8]][2,2],4)` | `r round(unadj.glm.h1LAZ[[8]][2,4],4)`
Sanitation | Adjusted GLM | `r round(adj.glm.h1LAZ[[2]][2,1],2)` |(`r round(adj.glm.h1LAZ[[2]][2,2:3],2)`) | `r round(adj.glm.h1LAZ[[8]][2,2],4)` | `r round(adj.glm.h1LAZ[[8]][2,4],4)`
Sanitation | Adjusted GLM + TMLE | | | | 
Sanitation | Adjusted SL + TMLE | | | | 
-----------------------------------------|--------------------------------------|---------------|--------------|------------|-------------
Handwashing | Unadjusted MH | `r round(exp(diff.h1LAZ[3,1]),2)` |(`r round(exp(diff.h1LAZ[3,3:4]),2)`) | `r round(diff.h1LAZ[3,2],4)`| `r round(diff.h1LAZ[3,5],4)`
Handwashing | Unadjusted GLM |  `r round(unadj.glm.h1LAZ[[3]][2,1],2)` |(`r round(unadj.glm.h1LAZ[[3]][2,2:3],2)`) | `r round(unadj.glm.h1LAZ[[9]][2,2],4)` | `r round(unadj.glm.h1LAZ[[9]][2,4],4)`
Handwashing | Adjusted GLM | `r round(adj.glm.h1LAZ[[3]][2,1],2)` |(`r round(adj.glm.h1LAZ[[3]][2,2:3],2)`) | `r round(adj.glm.h1LAZ[[9]][2,2],4)` | `r round(adj.glm.h1LAZ[[9]][2,4],4)`
Handwashing | Adjusted GLM + TMLE | | | | 
Handwashing | Adjusted SL + TMLE | | | | 
-----------------------------------------|--------------------------------------|---------------|--------------|------------|-------------
WSH | Unadjusted MH | `r round(exp(diff.h1LAZ[4,1]),2)` |(`r round(exp(diff.h1LAZ[4,3:4]),2)`) | `r round(diff.h1LAZ[4,2],4)`| `r round(diff.h1LAZ[4,5],4)`
WSH | Unadjusted GLM |  `r round(unadj.glm.h1LAZ[[4]][2,1],2)` |(`r round(unadj.glm.h1LAZ[[4]][2,2:3],2)`) | `r round(unadj.glm.h1LAZ[[10]][2,2],4)` | `r round(unadj.glm.h1LAZ[[10]][2,4],4)`
WSH | Adjusted GLM | `r round(adj.glm.h1LAZ[[4]][2,1],2)` |(`r round(adj.glm.h1LAZ[[4]][2,2:3],2)`) | `r round(adj.glm.h1LAZ[[10]][2,2],4)` | `r round(adj.glm.h1LAZ[[10]][2,4],4)`
WSH | Adjusted GLM + TMLE | | | | 
WSH | Adjusted SL + TMLE | | | | 
-----------------------------------------|--------------------------------------|---------------|--------------|------------|-------------
Nutrition | Unadjusted MH | `r round(exp(diff.h1LAZ[5,1]),2)` |(`r round(exp(diff.h1LAZ[5,3:4]),2)`) | `r round(diff.h1LAZ[5,2],4)`| `r round(diff.h1LAZ[5,5],4)`
...
Nutrition | Adjusted SL + TMLE | | | | 
-----------------------------------------|--------------------------------------|---------------|--------------|------------|-------------
WSH+N | Unadjusted MH | `r round(exp(diff.h1LAZ[6,1]),2)` |(`r round(exp(diff.h1LAZ[6,3:4]),2)`) | `r round(diff.h1LAZ[6,2],4)`| `r round(diff.h1LAZ[6,5],4)`
WSH+N | Unadjusted GLM |  `r round(unadj.glm.h1LAZ[[6]][2,1],2)` |(`r round(unadj.glm.h1LAZ[[6]][2,2:3],2)`) | `r round(unadj.glm.h1LAZ[[12]][2,2],4)` | `r round(unadj.glm.h1LAZ[[12]][2,4],4)`
WSH+N | Adjusted GLM | `r round(adj.glm.h1LAZ[[6]][2,1],2)` |(`r round(adj.glm.h1LAZ[[6]][2,2:3],2)`) | `r round(adj.glm.h1LAZ[[12]][2,2],4)` | `r round(adj.glm.h1LAZ[[12]][2,4],4)`
WSH+N | Adjusted GLM + TMLE | | | | 
WSH+N | Adjusted SL + TMLE | | | | 
-----------------------------------------|--------------------------------------|---------------|--------------|------------|-------------
